...
ActiveRecord::Schema.define(version: 20151122171420) do
  ...
  add_index "active_games", ["game_id"], name: "index_active_games_on_game_id"
  add_index "active_games", ["user_id"], name: "index_active_games_on_user_id", unique: true
